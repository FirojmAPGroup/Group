                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Your valid email.." value="{{ $user->email }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="admin_title"> Service Area Pincode
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" id="service_pincode" name="service_pincode" placeholder="Service Area Pincode" value="{{ $user->service_pincode }}" required oninput="limitLength(this, 6)">
                                    </div>
                                </div>
                                @if(!$user->getId())
                                <div class="form-group row">
...
<script>
    ...
    if (value.length <= maxLength) {
        ...
        if (!$(element).next().hasClass('error')) {
            $(element).after('<label class="error" style="dispaly:block;">This Field Should Be Exact '+maxLength+' Digits</label>');
        }
